...
function BlueBoxWithNav() {
    return(
        <div className="relative flex-3 min-h-[85vh] w-full flex flex-col bg-cover bg-center bg-secondary rounded-box shadow-xl text-primary-content p-5">
            <Cubes />
            {/* Navbar */}
            <div>
                <NavBar />
            ...
            <div className="hero h-full w-full bg-transparent place-content-center flex-3 -translate-y-1/2'">
                <div className="hero-content flex-col lg:flex-row-reverse size-full">
                    ...
                    <div className="flex1">
                        <div className='size-full relative scale-80 lg:scale-100 xl:scale-120 -translate-y-1/20'>
                            <svg className='h-[25rem]' height="452" width="452" viewBox="0 0 452 452" fill="none" xmlns="http://www.w3.org/2000/svg">
